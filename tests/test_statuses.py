import pytest
from inpost.static.statuses import ParcelCarrierSize, ParcelLockerSize, ParcelDeliveryType, ParcelShipmentType, \
...
def test_parcel_type_normal(test_input, expected):
    ...
    assert parcel_type_new == parcel_type_get, f"parcel_type_new: {parcel_type_new} != parcel_type_get: {parcel_type_get}"
...
def test_parcel_point_operations_bracket(test_input, expected):
    ...
    assert parcel_point_operation == expected, f"parcel_point_operation: {parcel_point_operation} != expected: {expected}"
...
def test_parcel_point_operations_normal(test_input, expected):
    ...
    assert parcel_point_operation_new == parcel_point_operation_get, f"parcel_point_operation_new: {parcel_point_operation_new} != parcel_point_operation_get: {parcel_point_operation_get}"
...
@pytest.mark.parametrize("test_input,expected",
                         [(None, None),
                          ...
                          ("COURIER_AVIZO_IN_CUSTOMER_SERVICE_POINT",
                           ParcelStatus.COURIER_AVIZO_IN_CUSTOMER_SERVICE_POINT),
                          ("TAKEN_BY_COURIER_FROM_CUSTOMER_SERVICE_POINT",
                           ParcelStatus.TAKEN_BY_COURIER_FROM_CUSTOMER_SERVICE_POINT),
...
@pytest.mark.parametrize("test_input,expected",
                         [("W trakcie przygotowania", "CREATED"),
                          ...
                          ("Odebrana przez kuriera z punktu obsługi klienta",
                           "TAKEN_BY_COURIER_FROM_CUSTOMER_SERVICE_POINT"),
...
def test_parcel_status_bracket(test_input, expected):
    ...
    assert parcel_status_new == parcel_status_get, f"parcel_status_new: {parcel_status_new} != parcel_status_get: {parcel_status_get}"
...
def test_delivery_type_bracket(test_input, expected):
    ...
    assert delivery_type_new == delivery_type_get, f"delivery_type_new: {delivery_type_new} != delivery_type_get: {delivery_type_get}"
...
def test_returns_status_bracket(test_input, expected):
    ...
    assert returns_status_new == returns_status_get, f"returns_status_new: {returns_status_new} != returns_status_get: {returns_status_get}"
...
def test_parcel_ownership_bracket(test_input, expected):
    ...
    assert parcel_ownership_new == parcel_ownership_get, f"parcel_ownership_new: {parcel_ownership_new} != parcel_ownership_get: {parcel_ownership_get}"
...
def test_compartment_expected_status_bracket(test_input, expected):
    ...
    assert compartment_expected_new == compartment_expected_get, f"compartment_expected_new: {compartment_expected_new} != compartment_expected_get: {compartment_expected_get}"
...
def test_compartment_actual_status_bracket(test_input, expected):
    ...
    assert compartment_actual_new == compartment_actual_get, f"compartment_actual_new: {compartment_actual_new} != compartment_actual_get: {compartment_actual_get}"
...
def test_payment_type_bracket(test_input, expected):
    ...
    assert payment_type_new == payment_type_get, f"payment_type_new: {payment_type_new} != payment_type_get: {payment_type_get}"
...
def test_payment_status_bracket(test_input, expected):
    ...
    assert payment_status_new == payment_status_get, f"payment_status_new: {payment_status_new} != payment_status_get: {payment_status_get}"
...
def test_parcel_service_name_bracket(test_input, expected):
    ...
    assert parcel_servicename_new == parcel_servicename_get, f"parcel_servicename_new: {parcel_servicename_new} != parcel_servicename_get: {parcel_servicename_get}"
